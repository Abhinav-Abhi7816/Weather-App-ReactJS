                ...
                <div className='flex flex-col place-items-center md:gap-16 gap-6 p-7 md:pt-36 pt-24 w-[100%]'>
                    ...
                    <div className='flex justify-around place-items-center md:text-3xl text-xl text-white md:px-16 md:gap-20 gap-3 flex-wrap'>
                        <div className='bg-[rgb(0,0,0,0.05)] rounded-3xl'>
                            <div className='bg-[rgb(255,255,255,0.2)] p-7 py-10 rounded-3xl flex flex-col md:gap-6 gap-2 md:w-96 min-w-[300px] shadow-2xl' style={{ boxShadow: "2px 4px 20px rgb(0,0,0,0.2" }}>
                                <p>Temperature:</p>
                                {(data) ? <ul className='flex flex-col gap-4'><p className='md:text-6xl text-4xl'>{data.temp} F</p>
                        ...
                        <div className='bg-[rgb(0,0,0,0.05)] rounded-3xl'>
                            <div className='bg-[rgb(255,255,255,0.2)] p-7 py-10 rounded-3xl flex flex-col gap-6 md:w-96 min-w-[300px] shadow-2xl' style={{ boxShadow: "2px 4px 20px rgb(0,0,0,0.2" }}>
                                <p>Humididty:</p>
                        ...
                        <div className='bg-[rgb(0,0,0,0.05)] rounded-3xl'>
                            <div className='bg-[rgb(255,255,255,0.2)] p-7 py-10 rounded-3xl flex flex-col gap-6 md:w-96 min-w-[300px] shadow-2xl' style={{ boxShadow: "2px 4px 20px rgb(0,0,0,0.2", textShadow: "2px 4px 20px rgb(0,0,0,0.3)" }}>
                                <p>Wind:</p>
                                {data ? <ul className='flex flex-col gap-4'>
                                    <p className='md:text-6xl text-4xl'>{data.windspeed} Kmph</p>
